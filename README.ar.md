...
شوف [CONTRIBUTING.md](CONTRIBUTING.md) لإعداد بيئة التطوير والأسلوب ومتطلبات الاختبار، و[CODE_OF_CONDUCT.md](CODE_OF_CONDUCT.md) لكيف المشروع متوقّع الناس تتعامل مع بعض، و[CHANGELOG.md](CHANGELOG.md) لشو تغيّر بين النسخ.
