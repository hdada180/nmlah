...
This is a small, single-maintainer project. There is no dedicated moderation team; the maintainer (hdada180)
handles reports personally, in spare time, and will explain any moderation action taken and why, if asked.

## Scope

This Code of Conduct applies within all project spaces — the issue tracker, pull requests, discussions — and
when an individual is officially representing the project elsewhere.

## Enforcement

Report unacceptable behavior by opening an issue that says only *"conduct report, please advise how to reach you
privately"* — no details in the public issue — and the maintainer will follow up with a private channel. As with
[security reports](SECURITY.md), expect an acknowledgement within about a week; there is no contractual SLA.
...
Project maintainers will follow these Community Impact Guidelines in determining the consequences for any action
...
specified period of time. No public or private interaction with the people involved is allowed during this
